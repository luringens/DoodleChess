...
class SetupScoreScreen implements Screen {
    ...
    public SetupScoreScreen(Game game, AssetManager assetManager)
    {
        ...
        playButton = new Button("Go Back", assetManager);
    ...
    private void addDifficultyList(int player)
    {
        ...
        title.setText("ScoreBoard" + (player == -1 ? "1" : "2"));
        title.setColor(0,0,0,1);
        stage.addActor(title);
